...
namespace AtomicCore.BlockChain.TronNet
{
    ...
    public class ABIDeserialiser
    {
        ...
        public FunctionABI BuildFunction(IDictionary<string, object> function)
        {
            ...
            FunctionABI functionABI = new FunctionABI((string)function["name"], constant,
                TryGetSerpentValue(function))
            {
                InputParameters = BuildFunctionParameters((List<object>)function["inputs"]),
                OutputParameters = BuildFunctionParameters((List<object>)function["outputs"])
            };
